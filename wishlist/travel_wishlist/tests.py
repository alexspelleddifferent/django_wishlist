...
class TestPlaceDetail(TestCase):
    ...
    def test_add_date_visited(self):
        ...
        # I had to update this test because the way this version of django works is that it prints the date in a specific format - alex
        date_visited_formatted = "Jan. 1, 2014"
        ...
        # and correct data shown on page?
        self.assertContains(response, date_visited_formatted)  # new text shown
